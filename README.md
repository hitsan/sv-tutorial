...
- **学習トピック**:
  - FIRフィルタ（直接形、転置形、パイプライン化）

- **詳細**: `05_dsp/README.md`

### 6. 画像処理 (Image Processing)
**ディレクトリ**: `06_image_processing/`
...
- **詳細**: `06_image_processing/README.md`

### 7. ネットワーク処理 (Network)
**ディレクトリ**: `07_network/`

ネットワークプロトコルの実装を学習します。
...
- **詳細**: `07_network/README.md`

### 8. メモリアーキテクチャ (Memory Architecture)
**ディレクトリ**: `08_memory_arch/`

メモリシステムとデータ転送の基礎を学習します。

- **学習トピック**:
  - ダイレクトマップキャッシュ
  - DMA (Memory to Stream)

- **詳細**: `08_memory_arch/README.md`

### 9. 制御ロジック (Control Logic)
**ディレクトリ**: `09_control/`

ハードウェアスケジューリングの基礎を学習します。

- **学習トピック**:
  - ハードウェアスケジューラ（ラウンドロビン）

- **詳細**: `09_control/README.md`
